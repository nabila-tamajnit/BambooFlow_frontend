...
export const Login = () => {
    ...
    const isFirstLogin = !!successMessage;
        ...
        <main className="min-h-[80vh] flex items-center justify-center p-6 bg-main-50/50">
            <div className="w-full max-w-md bg-white rounded-[2.5rem] p-10 shadow-2xl shadow-main-200/50 border border-main-100 relative overflow-hidden">
                ...
                <div className="text-center mb-10 relative">
                    <h1 className="text-4xl text-main-800 font-chewy mb-2">
                        {isFirstLogin ? 'Bienvenue dans ta forêt !' : 'Bon retour !'}
                    </h1>
                    <p className="text-main-500 font-medium text-sm px-8">
                        {isFirstLogin
                            ? 'Connecte-toi pour commencer à cultiver ta productivité. 🌱'
                            : 'Le panda a hâte de voir tes progrès aujourd\'hui. 🌿'
                        }
                    </p>
                </div>
